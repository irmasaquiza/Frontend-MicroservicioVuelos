...
<template>
  <button
    ...
    :class="[
      ...
      ancho && 'w-full',
      variante === 'primario'  && 'bg-gold hover:bg-gold-dark text-white focus-visible:ring-gold shadow-sm shadow-red-100',
      variante === 'secundario'&& 'bg-white border border-border text-navy hover:bg-red-50 focus-visible:ring-blue-accent',
